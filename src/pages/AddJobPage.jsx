...
const AddJobPage = ({ addJobSubmit }) => {
    ...
    const [type, useType] = useState('Full-Time');
    const [location, useLocation] = useState('');
    const [description, useDescription] = useState('');
    const [salary, useSalary] = useState('Under $50K');
    const [companyName, useCompanyName] = useState('');
    const [companyDescription, useCompanyDescription] = useState('');
    const [contactEmail, useContactEmail] = useState('');
    const [contactPhone, useContactPhone] = useState('');
